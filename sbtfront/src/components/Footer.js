  ...
  return (
    ...
    >
      <Stack
        ...
        sx={{ height: 60, background: "#4A6BD6" }}
      >
        <Stack
          direction="row"
          alignItems="center"
      ...
      <Stack
        alignItems="center"
        justifyContent="center"
        sx={{ height: "80%", background: "#374999" }}
      >
        <Stack
          direction="row"
          alignItems="center"
        ...
        >
          ...
          >
            ...
            >
              <Button sx={{ width: "13%", background: "#4A6Bd6" }}>
      ...
      >
        ...
        >
          <Stack sx={{ color: "white" }}>2023.3.8 ~ 2022.5.22</Stack>
          <Stack sx={{ color: "white" }}>Develop by team 15 With 최자실, 김도현, 신유정, 정가영</Stack>
        </Stack>
      </Stack>
    </Stack>
  );
